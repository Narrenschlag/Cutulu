namespace Cutulu.Mesh
{
    ...
    public class MeshBuilder2
    {
        ...
        public MeshBuilder2(MeshType type) : this(type, Colors.White) { }
        public MeshBuilder2(MeshType type, Color baseColor)
        {
            BaseColor = baseColor;
            Type = type;
        ...
        public void Apply(MeshInstance3D meshInstance3D, bool useVertexColor = false)
        {
            ...
            if (useVertexColor)
                ...
                Render.VertexMaterialAlpha : Render.VertexMaterial;
        }
