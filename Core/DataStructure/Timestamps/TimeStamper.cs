...
public partial class TimeStamper<STAMP>
    where STAMP : struct, INumber<STAMP>, IMinMaxValue<STAMP>, IDivisionOperators<STAMP, STAMP, STAMP>, IIncrementOperators<STAMP>
{
    ...
    public bool IsValid(object _key, STAMP _stamp)
    {
        ...
        if (Timestamps.TryGetValue(_key, out var _timestamp) &&
            _stamp < _timestamp && _timestamp - _stamp < STAMP.MaxValue / HalfDiv
        ) return false;
